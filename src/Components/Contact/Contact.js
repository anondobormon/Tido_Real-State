    ...
    <div>
      <div className="container mx-auto pt-16">
        <div className="lg:flex">
          <div className="xl:w-2/5 lg:w-2/5 bg-pink-700 py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
          ...
          <div className="xl:w-3/5 lg:w-3/5 bg-gray-200 h-full pt-5 pb-5 xl:pr-5 xl:pl-0 rounded-tr rounded-br">
            ...
            >
              ...
              <div className="w-full mt-6">
                ...
                <button
                  type="submit"
                  className="focus:outline-none bg-pink-700 transition duration-150 ease-in-out hover:bg-pink-600 rounded text-white px-8 py-3 text-sm leading-6"
                >
                  Submit
                </button>
              </div>
